...
public class OperacionMapper {
    ...
    public OperacionFormDTO toFormDTO(Operacion entity) {
        ...
        return OperacionFormDTO.builder()
                ...
                .trans(entity.getTrans() != null ? entity.getTrans().toString() : null)
                .busquedaBienes(entity.getBusquedaBienes() != null ? entity.getBusquedaBienes().toString() : null)
                .escribanoLegal(entity.getEscribanoLegal())
                .codigoExpCautelar(entity.getCodigoExpCautelar())
                .incidente(entity.getIncidente() != null ? entity.getIncidente().toString() : null)
                .montoDemandado(entity.getMontoDemandado())
    ...
    public Operacion toEntityFromForm(OperacionFormDTO form, Cliente cliente, Agencia agencia, Usuario abogado) {
        ...
        return Operacion.builder()
                ...
                .abogado(abogado)
                .trans(form.getTrans() != null && !form.getTrans().isEmpty() ? Boolean.valueOf(form.getTrans()) : null)
                .busquedaBienes(form.getBusquedaBienes() != null && !form.getBusquedaBienes().isEmpty() ? Boolean.valueOf(form.getBusquedaBienes()) : null)
                .escribanoLegal(form.getEscribanoLegal())
                .codigoExpCautelar(form.getCodigoExpCautelar())
                .incidente(form.getIncidente() != null && !form.getIncidente().isEmpty() ? Boolean.valueOf(form.getIncidente()) : null)
