...
public class CarteraService {
    ...
    private ParseResult parseRow(Row row, JsonNode columns,
        ...
        if (partidaRegistral != null && !partidaRegistral.isBlank()) {
            BienEmbargado bien = BienEmbargado.builder()
                    ...
                    .fechaInadmisibleMc(getCellString(row, columns, "fechaInadmisibleMc"))
                    .fechaAdmisionMc(getCellString(row, columns, "fechaAdmisionMc"))
    ...
    private ImportacionDTO toDTO(Importacion entity, String agenciaNombre) {
        return ImportacionDTO.builder()
                ...
                .registrosCreados(entity.getRegistrosCreados())
                .registrosActualizados(entity.getRegistrosActualizados())
